...
public class ChunkedWorldInitialiser : MonoBehaviour
{
    ...
    public void InitWorld()
    {
        ...
        if (LevelConfigManager.Instance.config.dungeon != null)
        {
            dungeon.prefab = LevelConfigManager.Instance.config.dungeon;
        }
    ...
    private Vector3 RandomizeGoalChunk(GoalConfig goal)
    {
        ...
        Instantiate(goal.prefab, (chunkPosition * this.chunk.tileSize) + goal.prefab.transform.position, goal.prefab.transform.rotation);
